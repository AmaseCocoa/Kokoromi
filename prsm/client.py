...
SCHEMA_PATH = Path('C:/Users/AmaseCocoa/Desktop/Kokoromi/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'windows': 'C:\\Users\\AmaseCocoa\\.cache\\prisma-python\\binaries\\5.17.0\\393aa359c9ad4a4bb28630fb5613f9c281cde053\\node_modules\\prisma\\query-engine-windows.exe'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    cmsmeta: 'actions.cmsMetaActions[models.cmsMeta]'
    post: 'actions.PostActions[models.Post]'
    sociallink: 'actions.socialLinkActions[models.socialLink]'
    ...
    def __init__(
        ...
        *,
        ...
        self._set_generated_properties(
            ...
            active_provider='cockroachdb',
            default_datasource_name='db',
        )

        self.cmsmeta = actions.cmsMetaActions[models.cmsMeta](self, models.cmsMeta)
        self.post = actions.PostActions[models.Post](self, models.Post)
        self.sociallink = actions.socialLinkActions[models.socialLink](self, models.socialLink)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            'name': 'db',
            'url': OptionalValueFromEnvVar(**{'value': 'postgresql://kokoromi:cKgnltJhjEz-l95n6k_XLQ@amasec-blog-1444.jxf.cockroachlabs.cloud:26257/defaultdb?sslmode=verify-full', 'fromEnvVar': None}).resolve(),
            'source_file_path': 'C:/Users/AmaseCocoa/Desktop/Kokoromi/prisma/schema.prisma',
        }
...
class Batch:
    cmsmeta: 'cmsMetaBatchActions'
    post: 'PostBatchActions'
    sociallink: 'socialLinkBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.cmsmeta = cmsMetaBatchActions(self)
        self.post = PostBatchActions(self)
        self.sociallink = socialLinkBatchActions(self)
